...
public class Main {
    public static void main(String[] args) {
        ...
        Parking parking = new Parking("Underground examPreparation.type03.parking garage", 5);
...
// The cars are parked in Underground examPreparation.type03.parking garage:
// Peugeot 307 (2011)
// Audi S4 (2005)
